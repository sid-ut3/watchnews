...
CREATE TABLE position_word(
        ...
        id_article_1 Varchar (50) NOT NULL ,
...
ALTER TABLE position_word ADD CONSTRAINT FK_position_word_id_article_1 FOREIGN KEY (id_article_1) REFERENCES article(id_article);
