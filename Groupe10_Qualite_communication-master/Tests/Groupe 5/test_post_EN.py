...
# Pierrick HERVE
# V1 : 3 test + setUp()
from g5_database_posts import post_EN
import pytest
...
def test_post_EN1(setUp):
    url_attendue = 'http://130.120.8.250:5005/var/www/html/projet2018/code/bd_index/\
        API/index/entity'
    url = str(setUp.url)
